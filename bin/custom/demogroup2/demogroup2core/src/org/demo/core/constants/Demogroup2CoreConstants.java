...
/**
 * Global class for all Demogroup2Core constants. You can add global constants for your extension into this class.
 */
public final class Demogroup2CoreConstants extends GeneratedDemogroup2CoreConstants
{
	public static final String EXTENSIONNAME = "demogroup2core";


	private Demogroup2CoreConstants()
	{
		//empty
	}

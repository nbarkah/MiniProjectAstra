...
import org.demo.test.constants.Demogroup2TestConstants;
 ...
 */
@SystemSetup(extension = Demogroup2TestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/demogroup2test/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/demogroup2test/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/demogroup2test/import/cstickets.impex");
			...
			importImpexFile(context, "/demogroup2test/import/csquotes.impex");
		}
	}
}

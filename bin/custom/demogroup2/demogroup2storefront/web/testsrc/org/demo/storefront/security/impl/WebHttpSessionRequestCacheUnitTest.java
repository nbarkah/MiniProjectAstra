...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/demogroup2storefront/electronics/en",
						"https://electronics.local:9002/demogroup2storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/demogroup2storefront/electronics/en",
						"https://electronics.local:9002/demogroup2storefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/demogroup2storefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/demogroup2storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/demogroup2storefront/electronics/en",
						"https://electronics.local:9002/demogroup2storefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/demogroup2storefront",
						"https://electronics.local:9002/demogroup2storefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/demogroup2storefront",
						"https://electronics.local:9002/demogroup2storefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/demogroup2storefront/electronics/en",
						"https://electronics.local:9002/demogroup2storefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
